...
def visualize_predicted_community_and_scatter(G, membership_pred_ranked, pos, K_true, palette, degree_info_file, output_prefix="dept_scatter"):
    ...
    for dept in sorted(dept_data.keys()):
        ...
        plt.xlabel("Internal-department-degrees")
        plt.ylabel("Externa-group-degrees")
...
def main():
    ...
    pos = create_3x1_layout_ordered(G_filtered, membership_true_ranked, grid_width=20.0, grid_height=10.0, radius_divisor=2.5, seed=1)
