...
def create_3x1_layout_ordered(G, membership, grid_width=20.0, grid_height=20.0, radius_divisor=2.0, seed=42):
    random.seed(seed)
...
def main():
    ...
    Z_hat,gamma_hat,beta_hat = gbeta(A, K_true,1024,128)
    ...
    pos = create_3x1_layout_ordered(G_filtered, membership_true_ranked, grid_width=15.0, grid_height=5.0, radius_divisor=2.5, seed=1)
