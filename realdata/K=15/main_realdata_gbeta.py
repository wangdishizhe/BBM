...
def main():
    ...
    Z_hat,gamma_hat,beta_hat = gbeta(A, K_true,1024,32)
    ...
    pos = create_5x3_layout_ordered(G_filtered, membership_true_ranked, grid_width=15.0, grid_height=25.0, radius_divisor=2.5, seed=1)
