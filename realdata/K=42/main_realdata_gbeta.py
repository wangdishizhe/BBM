...
def main():
    ...
    Z_hat,gamma_hat,beta_hat = gbeta(A, K_true,32768,16384)
    ...
    palette  = sns.color_palette("tab20", 20) + sns.color_palette("tab20b", 20) + [(0.5, 0.5, 0.5), (0.8, 0.2, 0.2)]
